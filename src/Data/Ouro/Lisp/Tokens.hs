...
data TokenType
    ...
    | Export           -- Module exports, can only be functions
    | Defun            -- Named functions that return a JSON LD object
    ...
    | FunctionSymbol !Text -- NEW: Variables/identifiers that explicitly end in '!'
    -- Literals
